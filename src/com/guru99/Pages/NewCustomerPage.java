...
public class NewCustomerPage {
	...
	By NewCustLink = By.tagName("NewCust");
	...
	public void AddCustomer () {
		...
		driver.findElement(CustName).sendKeys("Ricky Richards");
		driver.findElement(CustRadioGenM).click();
		driver.findElement(CustDob).sendKeys("17/05/1991");
		...
		driver.findElement(CustMobNo).sendKeys("9821454578");
		driver.findElement(CustEmail).sendKeys("ricky@gmail.com");
